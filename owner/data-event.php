...
<head>
	...
	<link rel="stylesheet" href="data-event.css">
	...
	<?php 
        ...
        <table class="table-conten">
            ...
            <tbody>
                ...
                //pagingnya
        $batas = 8;
        $qjum = mysqli_query($koneksi,"SELECT * FROM dt_event");
...
//batas paging
        //$data dapet tambahan LIMIT $posisi,$batas
            $data = mysqli_query($koneksi,"SELECT * from dt_event LIMIT $posisi,$batas");
            while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td><?php  echo "<a href='edit-event.php? id_event=$d[id_event]'><button> EDIT</button></a><a href='delete-event.php?id_event=$d[id_event]'><button>DELETE</button></a></tr>";?> </td>   
