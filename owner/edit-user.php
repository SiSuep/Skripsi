<?php 
    ...
    $ambildata = mysqli_query($koneksi, "SELECT * FROM dt_user WHERE id_user = '$id_user'");
...
<section id="tampilan-1">
    ...
    <div class="container-1">
     ...
     <div class="bawah">
        <form action="edit-user.php" method="POST" enctype="multipart/form-data" name="POST">
        <table>
            <input type="text" hidden="" value="<?php echo $_GET['id_user']; ?>" name="id_user">
            <div class="mb-3"> 
