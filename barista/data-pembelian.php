...
<section id="tampilan-2">
  ...
  <tbody>
    ...
    //pagingnya
        $batas = 8;
        $qjum = mysqli_query($koneksi,"SELECT * FROM dt_pembelian");
...
//batas paging
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM dt_pembelian LIMIT $posisi,$batas");
   $no = 1;
   while ($d = $query->fetch_assoc()) :
    ?>
                <tr>
                    ...
                    <td><?php  echo "<a href='edit-pembelian.php?id_pembelian=$d[id_pembelian]'><button>EDIT</button></a>";?> </td>   
                     <td><a href="detail-data-pembelian.php?id_pembelian=<?= $d['id_pembelian']; ?>" class="text-decoration-none font-weight-bolder text-warning">Detail Pembelian</a></td>
